      ...
      >
        ...
        <div style={{ position: 'absolute', top: 0, marginTop: '-4%', left: 0, right: 0, zIndex: 6, display: 'flex', justifyContent: 'center', pointerEvents: 'none' }}>
          <Image
            ...
            style={{ width: 'clamp(240px, 30vw, 360px)', height: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 40px rgba(245,168,0,0.28)) drop-shadow(0 8px 32px rgba(0,0,0,0.8))' }}
          />
        </div>
